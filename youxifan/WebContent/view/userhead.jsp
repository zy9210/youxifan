...
<script type="text/javascript" src="<%=contextPath %>/jcrop/js/swfobject.js"></script>
<script type="text/javascript" src="<%=contextPath %>/jcrop/js/jquery.1.3.2.js"></script>
<script type="text/javascript" src="<%=contextPath %>/jcrop/js/jquery.uploadify.v2.1.4.js"></script>
