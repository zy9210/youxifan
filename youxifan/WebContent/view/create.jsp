    ...
    <div class="container">
		...
		<div id="content">
	        ...
	        <div id="mainbar" class="ask-mainbar">  
	    		<form id="post-form" class="post-form" action="<%=contextPath%>/doc.do?method=add" method="post">
	        	<input type="hidden" id="doctype" name="doctype" value="1" />
	        		<div> 
		            	<div><label class="ask_title">标题</label></div>
		            	<input id="title" name="title" type="text" maxlength="300" tabindex="100" class="ask-title-field" value="">   
		            	<div><label class="ask_title">内容</label></div>
		            	<textarea id="post-text" class="wmd-input" name="post-text" cols="92" rows="15" tabindex="101">
						</textarea>
	        		</div> 
    ...
    <div id="footer">
        <div class="footerwrap">
            <div id="footer-menu">
                ...
                <a href="/faq">faq</a> | 
                <a href="http://blog.stackexchange.com?blt=1">blog</a> |
