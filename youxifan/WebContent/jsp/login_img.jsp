...
<!--[if IE]>
<style type="text/css">
.border, .rain{behavior: url(<%=contextPath%>/css/ie-css3.htc);}
</style>
<![endif]-->
...
<style>  
	body{
		...
		/*
		background: #000 url(<%=contextPath%>/images/wallpaper/1.jpg) 50% 50% center; 
		opacity: .30;
...
<body>
<!-- 
<img class="backimg" alt="" src="<%=contextPath%>/images/wallpaper/3.jpg">
-->
<div class="rain">
	<div class="border start">
		<form>
			...
			<div>
			<input type="checkbox" id="remlginstate" name="remlginstate"/>记住我的登录状态
			</div>
